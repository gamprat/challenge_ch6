          ...
          <div className='relative z-40 p-4'>
            <div className='flex justify-between bg-slate-950'>
              ...
              <div className="relative">
                <input type="search" className="bg-transparent border-2 text-white border-red-500 w-[30rem] h-[2.5rem] py-2 px-3 rounded-full focus:outline-none" placeholder="Search for movies..." />
